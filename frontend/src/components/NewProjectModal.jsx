        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3.5 py-2.5 text-sm text-zinc-100 outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/30"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3.5 py-2.5 text-sm text-zinc-100 outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/30 resize-none"
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            <input
              ...
              className="w-4 h-4 rounded border-zinc-600 bg-zinc-950 text-emerald-500 focus:ring-emerald-500/30 focus:ring-offset-0"
            />
