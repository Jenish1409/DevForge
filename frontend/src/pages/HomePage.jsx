...
const FEATURES = [
  {
    ...
    iconBg: 'bg-emerald-50 dark:bg-zinc-950 border-emerald-200 dark:border-zinc-800',
    description:
  ...
  },
  {
    ...
    iconBg: 'bg-cyan-50 dark:bg-zinc-950 border-cyan-200 dark:border-zinc-800',
    description:
  ...
  },
  {
    ...
    iconBg: 'bg-violet-50 dark:bg-zinc-950 border-violet-200 dark:border-zinc-800',
    description:
  ...
  },
  {
    ...
    iconBg: 'bg-amber-50 dark:bg-zinc-950 border-amber-200 dark:border-zinc-800',
    description:
    ...
    <>
      <section className="relative mx-auto max-w-6xl px-4 pt-20 pb-24 sm:px-6 sm:pt-28 sm:pb-32">
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-4 py-1.5 text-xs font-mono text-emerald-700 dark:text-emerald-400">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed sm:text-xl">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              href="#features"
              className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white/50 dark:bg-zinc-900/50 px-6 py-3 text-sm font-semibold text-zinc-700 dark:text-zinc-300 hover:border-zinc-400 dark:hover:border-zinc-600 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors"
            >
          ...
          <div className="mt-14 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/60 p-1 shadow-2xl shadow-zinc-400/20 dark:shadow-black/40 transition-colors">
            <div className="flex items-center gap-2 border-b border-zinc-200 dark:border-zinc-800 px-4 py-2.5">
              ...
              <span className="ml-2 font-mono text-[11px] text-zinc-400 dark:text-zinc-500">~/devforge/mock.sh</span>
            </div>
            <pre className="overflow-x-auto p-5 text-left text-sm leading-relaxed font-mono bg-white dark:bg-transparent rounded-b-lg transition-colors">
              <code>
                <span className="text-zinc-400 dark:text-zinc-500">$</span>{' '}
                <span className="text-emerald-600 dark:text-emerald-400">curl</span>{' '}
                <span className="text-zinc-700 dark:text-zinc-300">http://localhost:8080/mock/your-project/users</span>
                {'\n\n'}
                <span className="text-cyan-600 dark:text-cyan-400">{'{'}</span>
                {'\n'}
                {'  '}
                <span className="text-violet-600 dark:text-violet-400">&quot;id&quot;</span>
                <span className="text-zinc-400 dark:text-zinc-500">:</span>{' '}
                ...
                <span className="text-zinc-400 dark:text-zinc-500">:</span>{' '}
                <span className="text-emerald-600 dark:text-emerald-300">&quot;Not A Real User&quot;</span>
                <span className="text-zinc-400 dark:text-zinc-500">,</span>
                {'\n'}
                {'  '}
                <span className="text-violet-600 dark:text-violet-400">&quot;status&quot;</span>
                <span className="text-zinc-400 dark:text-zinc-500">:</span>{' '}
                <span className="text-emerald-600 dark:text-emerald-300">&quot;mocked&quot;</span>
                {'\n'}
                <span className="text-cyan-600 dark:text-cyan-400">{'}'}</span>
                {'\n\n'}
                <span className="text-zinc-400 dark:text-zinc-600"># No DTOs were harmed in the making of this response.</span>
              </code>
            </pre>
          </div>
        </div>
      ...
      <section id="features" className="relative border-t border-zinc-200 dark:border-zinc-800/80 bg-zinc-50/80 dark:bg-zinc-900/30 py-24 transition-colors">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="mx-auto max-w-2xl text-center mb-14">
            <p className="text-xs font-medium uppercase tracking-widest text-emerald-600 dark:text-emerald-500 mb-3">Features</p>
            <h2 className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 sm:text-4xl">
              Everything you need.
              <br />
              <span className="text-zinc-400 dark:text-zinc-500">Nothing your manager will ask for.</span>
            </h2>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {FEATURES.map((feature) => (
              <div
                key={feature.title}
                className={`group rounded-xl border bg-white dark:bg-zinc-900/50 p-6 transition-all hover:bg-zinc-50 dark:hover:bg-zinc-900/80 shadow-lg ${feature.glow} ${feature.border}`}
              >
                <div className={`mb-4 inline-flex rounded-lg border p-2.5 ${feature.iconBg} ${feature.accent}`}>
          ...
          <div className="mt-16 text-center">
            ...
            <Link
              to="/login"
              className="inline-flex items-center gap-2 text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300 font-medium text-sm transition-colors"
            >
